...
S6-2 (RedemptionCredential + AttendanceRecord + EntitlementReservation structure) and S6-3 (reservation/calendar/fulfillment reads) remain RESERVED/future; §3.5's attendance shape will be redefined by its owning slice per docs/35 §10/§18.
