...
**Status: W3-0 OWNER-APPROVED and CLOSED at `98c57ab`. Owner decisions D-W3-1 (separate PRIVATE evidence document storage — PostgreSQL-authoritative metadata, private object storage, no public URLs, server-controlled short-lived access; detail in W3-4) and D-W3-2 (three-layer rejection feedback: internal notes / machine reason code / provider-safe message; internal notes never auto-exposed; detail in W3-3/5/8) are APPROVED and binding. D-W3-3…6 remain deferred per §10. W3-1 (Admin Portal foundation, authentication & shell) is IMPLEMENTED — see the W3-1 record at the end of this document; W3-2 does NOT start without owner approval.**
