...
2. **Dead taps during the Home milestone.** Bottom-navigation tabs other than Home, "View all" links, and the credit preview give subtle press feedback but do not navigate anywhere. No scaffold, placeholder, or "coming soon" pages. This is a deliberate review-stage decision, not a defect.
