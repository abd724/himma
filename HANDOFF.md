...
**Recommended next milestone: Checkout** (HMA-021/022/023 — price presentation, payment representation, outcome states, confirmation), which first needs owner decisions on VAT/fees (docs/09 §21 / docs/21 §20.10) and an owner-approved plan document (docs/20/21 pattern).
